...
%token XOR_ASSIGN OR_ASSIGN VAR NUL ELVIS NEXTCASE ANYERR
%token TYPEDEF MODULE IMPORT DEFINE EXTERN
%token CHAR SHORT INT LONG FLOAT DOUBLE CONST VOID USZ ISZ UPTR IPTR VARIANT
...
catch_unwrap
	: CATCH rel_expr_or_list
	| CATCH IDENT '=' rel_expr_or_list
	| CATCH type IDENT '=' rel_expr_or_list
	;
